...
Tank #2 is assigned to target #0,
Aircraft #1 is assigned to target #0,
Grenade #1 is assigned to target #0,
Grenade #2 is assigned to target #1,
The expected total threat of the surviving targets is 15.048
 */
